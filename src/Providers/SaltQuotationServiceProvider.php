...
namespace SaltQuotation\Providers;

use Illuminate\Support\ServiceProvider;

class SaltQuotationServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        $this->publishes([
            __DIR__.'/../../config/salt-laravel-quotation.php' => config_path('salt-laravel-quotation.php'),
        ], 'quotation-config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-quotation');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-quotation');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/salt-laravel-quotation'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'salt-laravel-quotation');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/salt-laravel-quotation'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltQuotation\Console\Commands\SaltQuotationCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/salt-laravel-quotation'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/salt-laravel-quotation.php', 'salt-laravel-quotation'
        // );
    }
}
